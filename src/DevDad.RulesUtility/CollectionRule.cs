...
internal class CollectionRule<T, V>:ISimpleRule
{
    private readonly PropertyInfo _propToTest;

    public CollectionRule(string functionName, string targetProperty, IEnumerable<V> baseValue, RuleExpression expression)
    {
    ...
    public IEnumerable<V> BaseValue { get; init; }
